...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-md-12"> 
      ...
      <form id="search-form" action="/servicio/pagos/" method="get">
    ...
    <div class="col-md-12">                      
          ...
          <table id="myTable" class="table table-hover table-striped">
            ...
            <tbody>
              ...
              foreach ($payments as $payment) {                              
                include(BASE_SECTION_TEMPLATES_FOLDER . 'service/payment/_list_item.php');
              }
              ?>
              <?php } ?>                            
            </tbody>
      ...
      <?php 
        for( $i = 1; $i<=ceil(($total_items)/$item_per_page); $i++)
          echo "<a href='/servicio/pagos/?page=$i' class='btn btn-info btn-sm btn-fill btn-uabc-green pag_button'>".$i."</a>";
      ?>
    </div>
  </div>
</div>
