    ...
    <div class="col-md-12">                      
          ...
          <table id="myTable" class="table table-hover table-striped">
            ...
            <tbody>
              ...
              foreach ($students as $student) {                              
                include(BASE_SECTION_TEMPLATES_FOLDER . 'service/student/_list_item.php');
              }
              ?>
              <?php } ?>                            
            </tbody>
      ...
      <?php 
        for( $i = 1; $i<=ceil(($total_items)/$item_per_page); $i++)
          echo "<a href='/servicio/alumnos/?page=$i' class='btn btn-info btn-sm btn-fill btn-uabc-green pag_button'>".$i."</a>";
      ?>
    </div>
  </div>
</div>
