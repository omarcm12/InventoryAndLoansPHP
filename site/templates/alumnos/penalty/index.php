...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="col-xs-12 col-md-6">
      <a href="/alumnos/pagos" class="btn btn-info btn-fill pull-right btn-uabc-green" style="margin: 10px 5px;">Mis Pagos</a>
    </div>
  </div>
   <div class="row"> 
    <div class="col-md-12">                      
      ...
      for( $i = 1; $i<=ceil(($total_items)/$item_per_page); $i++)
        echo "<a href='/alumnos/adeudos/?page=$i' class='btn btn-info btn-sm btn-fill btn-uabc-green pag_button'>".$i."</a>";
      ?>
    </div>
  </div>
</div>
