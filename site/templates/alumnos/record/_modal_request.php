  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <!--<form action="/alumnos/historial/borrar/<?= $loan->ID()?>" method="post">
          <button type="submit" class="btn btn-info btn-sm btn-fill btn-uabc-green">Eliminar Solicitud</button>
          
        </form>-->
          <form action="/alumnos/historial/editar/<?= $loan->ID()?>" method="get">
          <button type="submit" type="button" class="btn btn-info btn-sm btn-fill btn-uabc-green">Editar</button>
